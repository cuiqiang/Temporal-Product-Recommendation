...
public:
    ...
    void SVD_cross(int step_count=1000, double lambda1=0.05, double lambda2=0.01, double beta1=0.035, double beta2 = 0.035, double gamma0 = 1, double threshold=0.001);
