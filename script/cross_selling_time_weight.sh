...
purchase_history=${datapath}/cross_selling_time_weight/purchase-40-55-1year-top1w-sort-id-uniq
...
${binpath}/cross_selling_train $purchase_history-train

${binpath}/cross_selling_predict $purchase_history-train.model $purchase_history-test
